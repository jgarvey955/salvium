...
namespace cryptonote
{
  ...
  private:
    ...
    // List iterators survive other entries' insertion, expiry and eviction.
    std::list<entry> m_entries;
    std::unordered_map<std::string, std::list<entry>::iterator> m_entries_by_id;
    std::unordered_map<std::string, crypto::hash> m_poll_cursors;
    std::deque<std::string> m_poll_cursor_order;
    ...
    std::unordered_set<std::string> m_active_hashes;
